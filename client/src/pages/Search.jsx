...
const Search = () => {
    ...
    useEffect(() => {
        (async () => {
            try {
                setLoading(true)
                const res = await fetch(`/api/posts?searchTerm=${searchTermState}&type=${formState.type}&parking=${formState.parking}&furnished=${formState.furnished}&offer=${formState.offer}&page=${pageCount}&limit=8`)
                                            ...
                                            listings.length !== 0 ?
                                                <>
                                                    ...
                                                    "
                                                            ...
                                                            <button
                                                                onClick={() => setPageCount(pageCount + 1)}
                                                                disabled={listings.length < 8 || loading}
                                                                className="join-item btn bg-brand-blue text-white hover:bg-brand-blue/90
                                                    disabled:bg-[#d5d5d5] disabled:text-[#a0a0a0]"
                                                            >
                                                                <FaAngleDoubleRight />
