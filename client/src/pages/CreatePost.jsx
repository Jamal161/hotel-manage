                                ...
                                <div className="info_container">
                                    ...
                                    <div className="additional_info mt-6 max-w-xs">
                                        ...
                                        <div className="additional_feature mt-3">
                                            <p className='font-heading text-black'>Average rating</p>
                                            <div className="form-control">
                                            <label className="label cursor-pointer flex items-center justify-start gap-2">
                                                    <input
                                                        id='parking'
                                                ...
                                                <label className="label cursor-pointer flex items-center justify-start gap-2">
                                                    <input
                                                        ...
                                                        {...register('parking')}
                                                    />
                                                    <span className="label-text font-medium" >Two Star</span>
                                                </label>
                                                <label className="label cursor-pointer flex items-center justify-start gap-2">
                                                    <input
                                                        id='furnished'
                                                        ...
                                                        {...register('furnished')}
                                                    />
                                                    <span className="label-text font-medium" >Three Star</span>
                                                </label>
                                                <label className="label cursor-pointer flex items-center justify-start gap-2">
                                                    <input
                                                        id='furnished'
                                                        ...
                                                        {...register('furnished')}
                                                    />
                                                    <span className="label-text font-medium" >Five Star</span>
                                                </label>
                                                <label className="label cursor-pointer flex items-center justify-start gap-2">
                                                    <input
                                                        id='offer'
                                        ...
                                        <div className=" mt-1">
                                            <div className="pricing_info flex flex-col">
                                                <p className="mt-3  font-heading text-black">Cost per night </p>
                                                <span className='text-sm font-content font-bold text-red-900'>($ /night)</span>
